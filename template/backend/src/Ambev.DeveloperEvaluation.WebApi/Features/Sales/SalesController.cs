...
public class SalesController : BaseController
{
    ...
    [HttpPut]
    [ProducesResponseType(typeof(ApiResponseWithData<ModifySaleResponse>), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> ModifSale([FromBody] ModifySaleRequest request, CancellationToken cancellationToken)
    {
